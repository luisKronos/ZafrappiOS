...
public class savePosition_WS : NSObject {
    ...
    public func savePosition(idVacant: String, idUser : String , with handler : @escaping CompletionBlock){
